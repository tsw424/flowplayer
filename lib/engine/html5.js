...
console.log('conf.preload', conf.clip.preload);
            api = videoTag[0] || createVideoTag(video, false, conf.clip.preload || "metadata").prependTo(root)[0];
            videoTag.find('source').remove();
