...
var flowplayer = module.exports = function(fn, opts, callback) {
  ...
  if (fn.nodeType) { // Is an element
    if (typeof fn.getAttribute('data-flowplayer-instance-id') !== 'undefined') { // Already flowplayer instance
  ...
  var videoTagConfig = function(videoTag) {
   ...
   return !opts && this.data("flowplayer") || this.each(function() {
      ...
      var root = $(this).addClass("is-loading"),
         ...
         conf = $.extend({}, flowplayer.defaults, flowplayer.conf, confObject, root.data()),
         storage = {},
         lastSeekPosition,
         engine,
         url,
      ...
      if (!root.data('flowplayer')) { // Only bind once
         root.bind("boot", function() {
            ...
            if (conf.splash) root.find('video').remove();
