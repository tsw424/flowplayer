...
$.extend(flowplayer, {
   ...
   defaults: {
      ...
      embed: "http://@CDN/@VERSION/iframe/",

      // first engine to try
      engine: 'html5',

      fullscreen: window == window.top || (document.fullscreenEnabled || document.webkitFullscreenEnabled || document.mozFullScreenEnabled),
...
$.fn.flowplayer = function(opts, callback) {
   ...
   return !opts && this.data("flowplayer") || this.each(function() {
      ...
      var root = $(this).addClass("is-loading"),
         ...
         urlResolver = new URLResolver(root, videoTag.length ? videoTag : conf.video),
         storage = {},
         lastSeekPosition,
         engine;
